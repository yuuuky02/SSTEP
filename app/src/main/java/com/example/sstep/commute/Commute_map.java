...
public class Commute_map extends AppCompatActivity implements OnMapReadyCallback {
        ...
        bottomonbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (inout != null && inout.equals("in")) {
                    isGoingToWork=true;
                    showCommuteIn_dialog.dismiss();
                    showCommuteOut_dialog.dismiss();
    ...
    // 현재 위치 버튼 표시 여부를 일치 여부에 따라 결정하는 메서드
            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        LatLng registeredLatLng = new LatLng(37.3454, 126.9561); // 등록된 사업장 위치 가져오기
...
//                                Toast.makeText(getApplicationContext(), "출근시간 저장 실패" + response.code(), Toast.LENGTH_SHORT).show();
